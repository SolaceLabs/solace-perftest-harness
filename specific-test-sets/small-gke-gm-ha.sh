#!/bin/bash
#Test set (guaranteed messaging) to run against a small GKE VMR group (similar to 2 cores)
#vmrs="35.195.159.62" #small VMR k8s cluster
...
";" #need to  end with to separate the various test arrays;
testarray4=""\
"4096:1:9000:2:${msg_type} "\
"4096:2:19000:2:${msg_type} "\
"4096:5:370000:2:${msg_type} "\
"4096:10:49000:2:${msg_type} "\
"4096:50:68000:2:${msg_type} "\
";" #need to  end with to separate the various test arrays;
testarray5=""\
"20480:1:2000:2:${msg_type} "\
"20480:2:4000:2:${msg_type} "\
"20480:5:8000:2:${msg_type} "\
"20480:10:8000:2:${msg_type} "\
"20480:50:8000:2:${msg_type} "\
";" #need to  end with to separate the various test arrays;
testarray6=""\
"51200:1:1500:2:${msg_type} "\
"51200:2:1500:2:${msg_type} "\
"51200:5:3000:2:${msg_type} "\
