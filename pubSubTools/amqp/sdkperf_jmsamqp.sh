...
CLASSPATH="$CLASSPATH" java $SOLACE_VM_ARGS com.solacesystems.pubsub.sdkperf.SDKPerf_java -api=THIRDPARTY -ecc=com.solacesystems.pubsub.sdkperf.jms.amqp.AmqpJms_2_0_Client "$@"
